...
<div class="faulh_container">
    <form id="filter_form" method="get">
        ...
        <fieldset>
            <a class="faulh-cancel-btn" href="<?php echo esc_url("admin.php?page=" . $_GET['page']); ?>"><?php esc_html_e('CANCEL', $this->plugin_text_domain) ?></a>
            ...
            <a id="<?php echo $this->plugin_name ?>_show_hide_advanced_search" href="#"><?php esc_html_e('Show Advanced Filters', $this->plugin_text_domain) ?></a>
        </fieldset>
