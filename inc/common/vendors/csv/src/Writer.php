...
class Writer extends AbstractCsv implements TabularDataWriter {
	...
	protected function resetProperties(): void {
		...
		$this->enclosure_replace = array(
			array( $this->enclosure, $this->escape . $this->enclosure . $this->enclosure ),
			array( $this->enclosure . $this->enclosure, $this->escape . $this->enclosure ),
		);
	}
	...
	public function insertOne( array $record ): int {
		$insert = fn ( array $record ): int|false => match ( true ) {
			$this->enclose_all => $this->document->fwrite(
				implode(
					$this->delimiter,
					array_map(
