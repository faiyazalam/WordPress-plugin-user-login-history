<?php
/**
 * User_Login_History_WP_List_Table
 *
 * From the codex https://codex.wordpress.org/Class_Reference/WP_List_Table:
 * This class's (WP_List_Table) access is marked as private.
 * That means it is not intended for use by plugin and theme developers as
 * it is subject to change without warning in any future WordPress release.
 * If you would still like to make use of the class,
 * you should make a copy to use and distribute with your own project, or else use it at your own risk.
 *
 * Due to the above reason I copied the class WP_List_Table here and then renamed it to User_Login_History_WP_List_Table to use in the plugin.
