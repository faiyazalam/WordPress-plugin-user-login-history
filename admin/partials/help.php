...
You can prevent this behavior by using the plugin setting.', 'faulh') ?></p>
            ...
            <p><strong><?php esc_html_e('Note', 'faulh') ?></strong> - <?php esc_html_e('In case a user log in with "remember me" and then closes his browser without doing logout, it will show the login status "Logged in".', 'faulh') ?></p>
