<div class="clearfix">
    <div class="user-login-history-right-col">
        ...
        <ol>
            ...
            <li><?php _e('Old Role', 'user-login-history'); ?></li>
 ...
 <h3><?php _e('I am here!', 'user-login-history'); ?></h3>
        ...
        <p>
            <a href="https://profiles.wordpress.org/faiyazalam" class="button-secondary" target="_blank">
                <?php _e('WordPress', 'user-login-history'); ?>
            </a>
           
            <a href="https://github.com/faiyazalam" class="button-secondary" target="_blank">
                <?php _e('Github', 'user-login-history'); ?>
            </a>
            <a href="http://stackoverflow.com/users/4380588/faiyaz-alam" class="button-secondary" target="_blank">
                <?php _e('StackOverFlow', 'user-login-history'); ?>
            </a>
